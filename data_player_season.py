...
def get_player_stats_by_season(season: str, season_type: str = "Regular Season", per_mode: str = "PerGame", measure_type: str = "Base") -> pd.DataFrame:
    """
    ...
    if "PLAYER_ID" in df.columns:
        df["PLAYER_URL"] = df["PLAYER_ID"].apply(lambda x: f"https://www.nba.com/player/{x}")
...
def collect_multiple_seasons(seasons: List[str]) -> pd.DataFrame:
    all_dfs = []
